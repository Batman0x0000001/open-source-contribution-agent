...
本文记录 Open Source Contribution Agent `0.3.6` 由自动化测试保护的核心设计约束。
...
| B5 | Delivery 文案来自模型，Job、Contract 与 workspace fingerprint 只由可信 Worker 绑定 | `SubmitDeliveryDraftTool`、`DeliveryDraft` | 模型 Schema 排除可信字段与 Artifact 绑定测试 |
